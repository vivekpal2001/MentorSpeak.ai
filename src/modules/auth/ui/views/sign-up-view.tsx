    ...
    return (
        ...
        <Card className="overflow-hidden p-0">
            <CardContent className="grid p-0 md:grid-cols-2">
                ...
                <div className="bg-radial from-red-500 to to-red-900 relative  flex flex-col gap-y-4 items-center justify-center">
        ...
        <div className="text-muted-foreground text-center *:[a]:hover:text-primary text-xs text-balanced *:[a]:underline *:[a]:underline-offset-4">
