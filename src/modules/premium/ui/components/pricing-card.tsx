...
const pricingCardVariants = cva("rounded-lg p-4 py-6 w-full", {
    variants: {
        variant: {
            ...
            highlighted: "bg-linear-to-br from-[#D05A1B] to-[#BD4E0F] text-white"
        }
    },
    defaultVariants: {
        variant: "default",
...
const pricingCardBadgeVariants = cva("text-bleck text-xs font-normal p-1", {
    variants: {
        variant: {
            default: "bg-primary/20",
            highlighted: "bg-[#f28643]"
        }
    },
    defaultVariants: {
        variant: "default",
