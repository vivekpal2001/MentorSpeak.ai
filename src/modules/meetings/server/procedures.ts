...
export const meetingsRouter = createTRPCRouter({
    ...
    .query(async ({ input, ctx }) => {
        ...
        if(!existingMeeting.transcritptUrl){
            return [];
        }

        const transcript = await fetch (existingMeeting.transcritptUrl)
        .then((res) => res.text())
        ...
        const transcriptWithSpearkers = transcript.map((item) => {
        ...
        return transcriptWithSpearkers; 
